...
var Header = function Header(props) {
  ...
  var state = { isFullscreen: isFullscreen, isModal: isModal, lang: lang };
...
var navigationItemCSS = function navigationItemCSS(_ref2) {
  ...
  return (
    ...
    defineProperty(_ref3, align, 20),
    defineProperty(_ref3, "&:hover", {
...
var NavigationPrev = function NavigationPrev(props) {
  ...
  return glam(
    Button,
    _extends(
      { type: "button", css: getStyles("navigationPrev", props) },
      innerProps
    ),
    children
  );
...
var NavigationNext = function NavigationNext(props) {
  var _props$children2 = props.children,
    children =
      _props$children2 === undefined
        ? glam(ChevronRight, { size: 48 })
        : _props$children2,
    getStyles = props.getStyles,
    innerProps = props.innerProps;
  ...
  return glam(
    Button,
    _extends(
      { type: "button", css: getStyles("navigationNext", props) },
      innerProps
    ),
    children
  );
...
var defaultCarouselComponents = function defaultCarouselComponents(
  providedComponents
) {
...
var defaultModalComponents = function defaultModalComponents(
  providedComponents
) {
...
var backdropClassNames = new Set(
  [
...
var Modal = (function (_Component) {
  ...
  function Modal(props) {
    ...
    _this.state = { isFullscreen: false, isClosing: false, lang: this.props.lang };
    return _this;
  }
    ...
    },
    {
      ...
      value: function render() {
        ...
        return glam(
          FullScreen,
          {
            handle: { active: isFullscreen },
            onChange: this.handleFullscreenChange,
          },
          glam(
            Fade,
            _extends({}, commonProps, { component: Blanket, in: transitionIn })
          ),
          glam(
            SlideUp,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleBackdropClick = function (event) {
    ...
    try {
      for (
        var _iterator = event.target.classList[Symbol.iterator](), _step;
...
function getNextLabel(_ref) {
  ...
  return `${lang.show_photo} ` + (currentIndex + 2) + ` z ` + views.length;
}
...
function getPrevLabel(_ref2) {
  ...
  return `${lang.show_photo} ` + currentIndex + ` z ` + views.length;
}
...
function getFullscreenLabel(_ref3) {
  ...
  return isFullscreen ? `${lang.exit_fullscreen} (f)` : `${lang.enter_fullscreen} (f)`;
}
  ...
  if (data.caption) {
    if (typeof data.caption !== "string") {
      console.warn(
        "Image " +
          (index + 1) +
          " has a non-string caption, but no alt\xA0value provided. This will probably make the alt prop unintelligible for screen readers. Is this intentional?"
      );
    }
    ...
    },
    {
      ...
      value: function render() {
        ...
        return glam(
          Container,
          _extends({}, commonProps, {
            innerProps: { innerRef: this.getContainer },
          }),
          this.renderHeader(),
          glam(
            ViewPager,
            ...
            glam(
              ...
              glam(
                ...
                views &&
                  views.map(function (data, index) {
                    return glam(
                      View$1,
                      { className: className("view-wrapper"), key: index },
                      glam(
                        View,
                        _extends({}, commonProps, { data: data, index: index })
                      )
                    );
                  })
              )
...
var _initialiseProps$1 = function _initialiseProps() {
  ...
  this.getFrame = function (ref) {
    ...
    _this2.frame = ref ? document.querySelector(`.${ref.props.className}`) : null;
...
var ModalGateway = (function (_Component) {
  ...
  function ModalGateway() {
    ...
    return possibleConstructorReturn(
      this,
      (ModalGateway.__proto__ || Object.getPrototypeOf(ModalGateway)).apply(
        this,
        arguments
      )
    );
  ...
  createClass(ModalGateway, [
    {
      ...
      value: function render() {
        ...
        return createPortal(
          React.createElement(TransitionGroup, FirstChild,
            children,
          ),
          target
        );
