...
export default function RodoMain(props) {
  ...
  return (
    <section className={classes.root} id={`rodo`}>
      <style>
        {`
    article > * {
      text-align: left;
      ...
      <Container maxWidth={`md`} className={classes.container}>
        ...
        <article>
          ...
          <p>
            ...
            "Firma Bednarz Mieczysław Bednarz", prowadząca działalność pod
            adresem: Wolica 124, 28-130 Stopnica, o nadanym numerze
            identyfikacji podatkowej (NIP): 6551022087, świadcząca usługi drogą
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Połączenie telefoniczne</strong> - +48 604 771 938 oraz
                +48 696 443 291
              </p>
            </li>
            <li>
              <p>
                ...
                https://naszechoinki.pl/ oraz https://naszechoinki.pl/sadzonki/
              </p>
            </li>
          </ul>
